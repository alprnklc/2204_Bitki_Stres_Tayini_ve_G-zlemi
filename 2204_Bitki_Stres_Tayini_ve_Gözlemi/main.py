...
class StressDetection:
    ...
    def foundBestİnd(self, showİmg=bool, repeatCount=int, disOrHealt=bool):


        İndivisualTable = dict()
        for i in range(repeatCount):
            best_individual = StressDetection(self.hPname,self.dPname).run_genetic_algorithm()
...
if __name__ == '__main__':
    ...
    for i in range(i):
        detector.foundBestİnd(True, i2, False)